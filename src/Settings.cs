...
namespace FixMyCrypto {
    class Settings {
        ...
        public static string passphrase { get { if (result.passphrase != null) return result.passphrase; else return ""; } }
        ...
        public static int logLevel {get { if (result.logLevel != null) return (int)result.logLevel.Value; else return (int)Log.LogLevel.Error; } }
